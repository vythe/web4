...
/*
 * Copied from javax.servlet.http.HttpUtils
 * from https://fossies.org/linux/www/apache-tomcat-9.0.85-src.tar.gz/apache-tomcat-9.0.85-src/java/javax/servlet/http/HttpUtils.java?m=t 
 * 
        ...
        try {
            ...
            do {
                ...
                if (inputLen <= 0) {
                	...
                	String msg = "err.io.short_read: expected {0} read {1}";
